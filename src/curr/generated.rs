...
#[cfg(all(not(feature = "std"), feature = "alloc"))]
use embedded_io::{BufRead, Read, Write, ErrorType, ErrorKind};
#[cfg(all(not(feature = "std"), feature = "alloc"))]
use embedded_io_cursor::Cursor;
#[cfg(all(not(feature = "std"), feature = "alloc"))]
pub type IOResult<T> = core::result::Result<T, ErrorKind>;
...
#[cfg(all(not(feature = "std"), feature = "alloc"))]
impl<R: Read> ErrorType for Limited<R> { type Error = ErrorKind; }
...
#[cfg(all(not(feature = "std"), feature = "alloc"))]
impl<R: BufRead> ErrorType for Limited<R> { type Error = ErrorKind; }
...
#[cfg(all(not(feature = "std"), feature = "alloc"))]
impl<W: Write> ErrorType for Limited<W> { type Error = ErrorKind; }
